...
.then(data =>{
    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            ...
            <p className='text-center'>To make a drink from coffee beans, the beans must first be specially <br /> prepared by drying the beans and then roasting. The beans are dried a <br /> short time after they are picked. This preserves  them and makes them ready to be packed <br /> or roasted. Before the beans are made into a drink,</p>
